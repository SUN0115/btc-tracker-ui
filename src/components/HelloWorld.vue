    ...
    <v-row v-if="!store.isLoading && store.mainData">
      <v-col cols="12" md="4">
        <v-card class="mb-4" elevation="2">
          <v-card-title>即時資訊</v-card-title>
          <v-list-item>
      ...
      <v-col cols="12" md="8">
        <v-card class="mb-4" elevation="2">
          <v-card-title>三日均價資訊</v-card-title>
          <v-list-item>
          ...
          <v-list-item class="text-green-accent-3">
            ...
            <v-list-item-subtitle>掛單賣出目標 (三日均價 +0.25%)</v-list-item-subtitle>
          </v-list-item>
          <v-list-item class="text-red-accent-3">
            <v-list-item-title>${{ formatPrice(store.mainData.threeDayAveragePriceDown5Percent)
              }}</v-list-item-title>
            <v-list-item-subtitle>掛單買入目標 (三日均價 -0.25%)</v-list-item-subtitle>
          </v-list-item>
          <v-divider class="my-2"></v-divider>
          <v-list-item>
            <v-list-item-title>
